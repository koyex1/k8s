...
#   description = "Allow inter-node communication for pod networking"
# }

# # Allow nodes to communicate with each other on UDP for VPC-CNI
...
#   description = "Allow inter-node UDP communication for pod networking"
# }
